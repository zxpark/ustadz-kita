...
public class DBHandlerKajian extends SQLiteOpenHelper {
	...
	public DBHandlerKajian(Context context, String dbName, String tableName) {
	...
	FormDataKajian getTitle(int id) {
		...
		FormDataKajian formData = new FormDataKajian(Integer.parseInt(cursor
	...
	public FormDataKajian getData(String IdNews) {
		// FormData DataList = new FormData();
		String selectQuery = "SELECT * FROM " + tableName + " WHERE tkj_id = "
				+ IdNews;
		...
		cursor.moveToFirst();
		FormDataKajian formData = new FormDataKajian();
	...
	public List<FormDataKajian> getAllData() {
		List<FormDataKajian> DataList = new ArrayList<FormDataKajian>();
		// Select All Query
	...
	public int updateData(FormDataKajian formData) {
		SQLiteDatabase db = this.getWritableDatabase();
	...
	public void deleteData(FormDataKajian formData) {
		SQLiteDatabase db = this.getWritableDatabase();
