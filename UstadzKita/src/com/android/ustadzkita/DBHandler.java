...
public class DBHandler extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_tableName = "CREATE TABLE " + tableName + "("
    ...
    void addData(FormData formData) {
        ...
        values.put(AR_TITLE, formData.getTitle()); // Contact Name
        values.put(AR_DATE, formData.getDate()); // Contact Phone
    ...
    FormData getTitle(int id) {
        ...
        Cursor cursor = db.query(tableName, new String[] { AR_ID,
                AR_TITLE, AR_DATE, AR_NAME, AR_DESC }, AR_ID + "=?",
    ...
    public FormData getData(String IdNews){
    	...
    	String selectQuery = "SELECT * FROM " + tableName + " WHERE Id = 'AR_ID'";
